...
$dotnet31Source = $sources.SelectSingleNode("add[@key='dotnet5.0']")
if ($dotnet31Source -ne $null) {
    AddPackageSource -Sources $sources -SourceName "dotnet5.0-internal" -SourceEndPoint "https://pkgs.dev.azure.com/dnceng/_packaging/dotnet5.0-internal/nuget/v2" -Creds $creds -Username $userName -Password $Password
    AddPackageSource -Sources $sources -SourceName "dotnet5.0-internal-transport" -SourceEndPoint "https://pkgs.dev.azure.com/dnceng/_packaging/dotnet5.0-internal-transport/nuget/v2" -Creds $creds -Username $userName -Password $Password
}
